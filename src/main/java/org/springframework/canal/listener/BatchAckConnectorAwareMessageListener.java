 ...
 */
@FunctionalInterface
public interface BatchAckConnectorAwareMessageListener<T> extends BatchMessageListener<T> {
    @Override
    ...
    @Override
    void onMessage(CanalEntries<T> data, Acknowledgment acknowledgment, CanalConnector connector);
